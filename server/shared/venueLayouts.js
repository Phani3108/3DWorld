...
export const VENUE_LAYOUTS = {
  ...
  // ═══════════════════════════════════════════════════════════════════
  // Phase 7D — tourist venues. No host; pure atmospheric dressing.
  // ═══════════════════════════════════════════════════════════════════
  hyd_charminar_bazaar: [
    { prop: "photoSpot",        grid: [42, 34] },
    { prop: "streetLamp",       grid: [39, 31] },
    { prop: "streetLamp",       grid: [45, 31] },
    { prop: "streetLamp",       grid: [39, 37] },
    { prop: "streetLamp",       grid: [45, 37] },
    { prop: "fruitCart",        grid: [41, 32] },
    { prop: "souvenirStall",    grid: [44, 35] },
    { prop: "informationKiosk", grid: [39, 36] },
  ],
  mum_marine_drive_walk: [
    { prop: "parkBench",    grid: [42, 11] },
    { prop: "parkBench",    grid: [45, 11] },
    { prop: "parkBench",    grid: [48, 11] },
    { prop: "streetLamp",   grid: [41, 12] },
    { prop: "streetLamp",   grid: [44, 12] },
    { prop: "streetLamp",   grid: [47, 12] },
    { prop: "photoSpot",    grid: [46, 13] },
    { prop: "fruitCart",    grid: [43, 13] },
  ],
  blr_cubbon_park: [
    { prop: "treeSmall",    grid: [13, 13] },
    { prop: "treeSmall",    grid: [17, 14] },
    { prop: "treeSmall",    grid: [14, 17] },
    { prop: "treeSmall",    grid: [18, 17] },
    { prop: "parkBench",    grid: [16, 15] },
    { prop: "parkBench",    grid: [15, 18] },
    { prop: "fountain",     grid: [16, 16] },
    { prop: "streetLamp",   grid: [13, 18] },
    { prop: "flowerPot",    grid: [18, 13] },
  ],
  dxb_marina_promenade: [
    { prop: "beachUmbrella",  grid: [32, 12] },
    { prop: "beachUmbrella",  grid: [37, 12] },
    { prop: "parkBench",      grid: [34, 11] },
    { prop: "parkBench",      grid: [36, 11] },
    { prop: "streetLamp",     grid: [31, 12] },
    { prop: "streetLamp",     grid: [38, 12] },
    { prop: "photoSpot",      grid: [34, 13] },
    { prop: "souvenirStall",  grid: [37, 13] },
  ],
  nyc_times_square: [
    { prop: "venueBillboard", grid: [12, 33] },
    { prop: "venueBillboard", grid: [15, 33] },
    { prop: "streetLamp",     grid: [11, 32] },
    { prop: "streetLamp",     grid: [16, 32] },
    { prop: "streetLamp",     grid: [11, 36] },
    { prop: "streetLamp",     grid: [16, 36] },
    { prop: "newspaperStand", grid: [13, 36] },
    { prop: "trashBinStreet", grid: [15, 36] },
    { prop: "photoSpot",      grid: [13, 34] },
  ],
  sg_gardens_by_the_bay: [
    { prop: "treeSmall",   grid: [41, 36] },
    { prop: "treeSmall",   grid: [45, 36] },
    { prop: "treeSmall",   grid: [43, 38] },
    { prop: "treeSmall",   grid: [41, 41] },
    { prop: "treeSmall",   grid: [45, 41] },
    { prop: "fountain",    grid: [43, 39] },
    { prop: "parkBench",   grid: [42, 37] },
    { prop: "parkBench",   grid: [44, 37] },
    { prop: "photoSpot",   grid: [43, 41] },
  ],
  syd_opera_forecourt: [
    { prop: "photoSpot",      grid: [37, 14] },
    { prop: "parkBench",      grid: [35, 14] },
    { prop: "parkBench",      grid: [39, 14] },
    { prop: "streetLamp",     grid: [34, 13] },
    { prop: "streetLamp",     grid: [40, 13] },
    { prop: "souvenirStall",  grid: [36, 16] },
    { prop: "informationKiosk", grid: [40, 16] },
  ],
};
